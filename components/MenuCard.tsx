...
export const MenuCard: React.FC<MenuCardProps> = ({ item, onAddToCart }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-red-100 p-4 flex flex-col justify-between h-full transition-transform hover:scale-[1.01] active:scale-[0.99]">
      <div>
